---
layout: post
title: 전광판 LED 숫자 비트로 나타내기
subtitle: 22251번 빌런 호석
categories: ps
tags: [ps, boj]
---

### 문제: [빌런 호석](https://www.acmicpc.net/problem/22251)

- 아래와 같이 LED 전광판으로 숫자를 나타내고, 주어진 비트 수로 숫자 A에서 숫자 B를 만들 수 있는지 판단해야 하는 문제입니다.

![스크린샷 2022-06-21 오후 5 46 27](https://user-images.githubusercontent.com/75410527/174761670-76a84708-af8f-4c43-bd35-21477e237333.png)
...
- 이 단계에서는 앞에 `비교용 숫자 만들기`를 통해 자릿수는 맞췄다고 가정합니다.
